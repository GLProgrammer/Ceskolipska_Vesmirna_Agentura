...
function LoadFlightsData()
{
	...
	xhr.onerror = function () { alert("Pravděpodobně není k dispozici připojení k internetu! Data lze takto přijímat, ale ne odesílat na web. (LoadFlightsData: Request to HTTP server failed.)"); };
	xhr.send();
}
